/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f0e1bea90bde910cccf01234bd7a1c77)
// Runtime types generated with workerd@1.20250906.0 2025-05-07 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		WEBAUTHN_APP_NAME: "przm";
		GOOGLE_MAPS_API_KEY: "__change_me__";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WEBAUTHN_APP_NAME" | "GOOGLE_MAPS_API_KEY" | "WEBAUTHN_RP_ID" | "AUTH_SECRET_KEY" | "DATABASE_URL">> {}
}
