...
export default defineScript(async ({ env }) => {
  ...
  // Create 10 test tow jobs with different statuses and priorities
  const towJobs = [
    {
      id: "job-1",
      jobNumber: "TJ-001",
    ...
    },
    {
      ...
      vehicleYear: 2017,
      vehicleColor: "Gray",
      licensePlate: "CHV2017",
      vin: "1G1ZE5ST8HF123456",
      pickupLocation: "Airport Terminal 3, Departure Level",
      pickupLatitude: 40.6413,
      pickupLongitude: -73.7781,
      dropoffLocation: "Enterprise Car Rental, 123 Airport Rd",
      dropoffLatitude: 40.6501,
      dropoffLongitude: -73.7845,
      distance: "3.2 mi",
      estimatedTime: "8 min",
      status: $Enums.JobStatus.DISPATCHED,
      priority: $Enums.JobPriority.HIGH,
      description: "Vehicle breakdown in departure zone, blocking traffic",
      estimatedCost: 150.00,
      driverName: "Mike Thompson",
      truckName: "Truck 02",
      scheduledAt: new Date("2025-01-15T15:45:00Z"),
      keysAvailable: true,
    },
    {
      id: "job-7",
      ...
      vehicleYear: 2020,
      vehicleColor: "Green",
      licensePlate: "SUB2020",
      vin: "4S4BSANC5L3123456",
      pickupLocation: "Mountain Trail Parking, Bear Creek Road",
      pickupLatitude: 40.8176,
      pickupLongitude: -74.1591,
      dropoffLocation: "Subaru Dealership, 678 Valley Rd",
      dropoffLatitude: 40.7484,
      dropoffLongitude: -74.0321,
      distance: "22.5 mi",
      estimatedTime: "35 min",
      status: $Enums.JobStatus.EN_ROUTE,
      priority: $Enums.JobPriority.NORMAL,
      description: "Flat tire on hiking trail, spare tire also flat",
      estimatedCost: 180.00,
      driverName: "Sarah Williams",
      truckName: "Off-Road Unit 01",
      scheduledAt: new Date("2025-01-15T09:15:00Z"),
      keysAvailable: true,
    },
    {
      id: "job-8",
      ...
      vehicleYear: 2019,
      vehicleColor: "Silver",
      licensePlate: "AUD2019",
      vin: "WAUENAF49KN123456",
      pickupLocation: "Corporate Office Complex, 1500 Business Park Dr",
      pickupLatitude: 40.7282,
      pickupLongitude: -74.0776,
      dropoffLocation: "German Auto Specialists, 234 Import Ave",
      dropoffLatitude: 40.7749,
      dropoffLongitude: -73.9442,
      distance: "15.8 mi",
      ...
      status: $Enums.JobStatus.ON_SCENE,
      priority: $Enums.JobPriority.LOW,
      description: "Transmission issues, car stuck in parking garage",
      estimatedCost: 220.00,
      driverName: "Carlos Rodriguez",
      truckName: "Heavy Duty 02",
    ...
    },
    {
      ...
      vehicleYear: 2021,
      vehicleColor: "Blue",
      licensePlate: "HYU2021",
      vin: "KMHL14JA5MA123456",
      pickupLocation: "University Campus, Student Parking Lot C",
      pickupLatitude: 40.7505,
      pickupLongitude: -73.9934,
      dropoffLocation: "Hyundai Service Center, 890 Auto Mall Dr",
      dropoffLatitude: 40.7831,
      dropoffLongitude: -73.9712,
      distance: "9.7 mi",
      estimatedTime: "20 min",
      status: $Enums.JobStatus.TOWING,
      priority: $Enums.JobPriority.NORMAL,
      description: "Engine won't turn over, possible starter failure",
      estimatedCost: 140.00,
      driverName: "Lisa Chen",
      truckName: "Truck 03",
      scheduledAt: new Date("2025-01-15T08:30:00Z"),
      keysAvailable: true,
    },
    {
      id: "job-10",
      ...
      vehicleColor: "Orange",
      licensePlate: "JEEP18",
      vin: "1C4HJWEG9JL123456",
      pickupLocation: "Beach Access Road, Mile 12",
      pickupLatitude: 40.5892,
      pickupLongitude: -74.1591,
      dropoffLocation: "Off-Road Recovery Shop, 567 4WD Street",
      ...
      status: $Enums.JobStatus.COMPLETED,
      priority: $Enums.JobPriority.URGENT,
      description: "Vehicle stuck in sand, axle damage from recovery attempt",
      estimatedCost: 300.00,
      actualCost: 285.00,
      driverName: "Jake Morrison",
      truckName: "Heavy Duty 03",
      scheduledAt: new Date("2025-01-14T13:00:00Z"),
      completedAt: new Date("2025-01-14T15:30:00Z"),
      keysAvailable: true,
    },
  ];
  ...
  console.log("🌱 Finished seeding with 1 user and 10 tow jobs");
});
