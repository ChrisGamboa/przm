...
INSERT INTO "new_TowJob" ("actualCost", "completedAt", "createdAt", "customerName", "customerPhone", "description", "dropoffLatitude", "dropoffLocation", "dropoffLongitude", "estimatedCost", "id", "licensePlate", "pickupLatitude", "pickupLocation", "pickupLongitude", "scheduledAt", "status", "towerId", "updatedAt", "vehicleColor", "vehicleMake", "vehicleModel", "vehicleYear", "vin") SELECT "actualCost", "completedAt", "createdAt", "customerName", "customerPhone", "description", "dropoffLatitude", "dropoffLocation", "dropoffLongitude", "estimatedCost", "id", "licensePlate", "pickupLatitude", "pickupLocation", "pickupLongitude", "scheduledAt", "status", "towerId", "updatedAt", "vehicleColor", "vehicleMake", "vehicleModel", "vehicleYear", "vin" FROM "TowJob";
DROP TABLE "TowJob";
